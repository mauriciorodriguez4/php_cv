...
<?php
    ...
    $id=$_GET["id_pelicula"]
    $sql = $conexion->query("Select * from peliculas where id_pelicula=$id");
?>
...
<div class="container">
    <div>
        <form action="editar_pelicula.php" method="POST">
         <input type="hidden" name="id_pelicula" value="<?$GET["id_pelicula"]?>">
         <?php
         include ("../controlador/editar.php");
         while ($datoPelicula=$sql->fetch_object()){?>
            ...
            <div class="input-group">
                ...
                <input type="file" class="form-control" aria-describedby="inputGroupFileAddon04" aria-label="Upload"
                    id="image_uploads" accept=".jpg, .jpeg, .png" multiple required name="image_uploads" value="<?=$datoPelicula->poster?>" />
            </div>
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="input-group my-3">
                        ...
                        <div class="form-floating">
                            ...
                            ?>
                                <option value="<?= $director['id_director'] ?>"><?=  $director['nombre_director'] ?>
                                </option>
                                <?php } ?>
                            </select>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="form-floating">
                            <input min="1930" max="2023" type="number" class="form-control" id="input_anio"
                                placeholder="Año" required name="estreno" />
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="form-floating">
                            <input min="0" type="number" class="form-control" id="input_recaudacion"
                                placeholder="Recaudacion en $" required name="recaudacion" />
            ...
            <div class="form-floating">
                <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
                    style="height: 100px" required name="sinopsis"></textarea>
